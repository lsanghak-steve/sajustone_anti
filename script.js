...
const braceletImage = document.getElementById('bracelet-image'); // 새로 추가된 팔찌 이미지 영역
...
// 5가지 천연석 추천 정보 및 새로 생성된 5가지 팔찌 이미지 주소 연결
const stones = {
    '목': { 
        ...
        bracelet_image: 'images/aventurine_bracelet_1779798000752.png'
    },
    '화': { 
        name: '가넷 (Garnet)', 
...
form.addEventListener('submit', function(event) {
    ...
    braceletImage.style.backgroundImage = 'url(' + recommendedStone.bracelet_image + ')'; // 팔찌 이미지 반영
